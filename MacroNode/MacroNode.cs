...
namespace AutoTestStructure
{
    ...
    /// <summary>
    /// Event Set의 저장&불러오기를 위한 구조체
    /// </summary>
    [Serializable]
    public struct PrefabsSaveFormat
    {
        public List<MacroNode> Prefabs;
        public HashSet<string> PrefabsDupCheckSet;
    }
